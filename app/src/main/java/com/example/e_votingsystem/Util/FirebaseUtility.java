package com.example.e_votingsystem.Util;
...
private Context context;
    ...
    //updatedata
    public void updateData(String path, String key, Map<String, Object> updateMap, Class<?> targetActivityClass, ProgressBar progressBar) {
...
progressBar.setVisibility(View.GONE);
    ...
    // Delete operation
    public void deleteData(String path,String key,Class<?> targetActivityClass,String notification) {
          if(notification.isEmpty()){
